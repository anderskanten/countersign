...
Filed the same session the review was received. Four fixes merged into
`CHARTER.md`, `README.md`, and `skills/decide/SKILL.md`; four items
recorded as deferred with a named condition for revisiting each.
